...
The graphic below shows the color for each student group for each indicator from the California 2023 Dashboard.

```{r}
#| results: asis 
#| echo: false 
http_address <- glue::glue("https://www.caschooldashboard.org/reports/{cds.dist}/2023")
